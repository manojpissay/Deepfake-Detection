...
def compiled_tcn(num_feat,  # type: int
    ...
    if not regression:
        ...
        # model.compile(get_opt(), loss='sparse_categorical_crossentropy', metrics=[ 'acc',tf.keras.metrics.AUC(), tf.keras.metrics.Precision(), tf.keras.metrics.Recall() ])
        # model.compile(get_opt(), loss='categorical_crossentropy', metrics=[accuracy, ])
